...
$messages['en'] = array(
    'supa-java-disabled' =>
        'You cannot paste images from clipboard because Java support'.
...
$messages['ru'] = array(
    'supa-java-disabled' =>
        'Вы не можете загружать изображения из буфера обмена, так как'.
        ' поддержка Java не включена в вашем броузере. Пожалуйста, установите модуль Java'.
        ' с сайта http://java.com/',
